...
public class SourceModuleIntegrationTest {
	...
	@Test
	public void test() {
		SingleNodeProcessingChainConsumer chain = chainConsumer(application, "testStream", String.format("fileExt --input.directory='%s' --host='%s' --port='%d'","/tmp/fileExt", "localhost",6379));
